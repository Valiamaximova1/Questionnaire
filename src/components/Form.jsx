...
function Form(){
  ...
  const handleSubmit=()=> { 
    ...
    .then(console.log("get method" + tt))
  } 
 
  if(textt[textt.length-1] !== undefined){
  tt = textt[textt.length-1].text.questionnaire_id 
  idid = textt[textt.length-1]._id
  }
...
<h1>Form</h1>
      <h1 >Voting Page {tt}</h1>
      {/* <p value={tt} onChange={(e) => setId(e.target.value)}></p> */}
